 ...
 */
export function validateTaskProposalSections(body: string): string[] {
 ...
 */
export function extractTeamId(marker: string): string | null {
 ...
 */
export function extractRound(marker: string): number | null {
