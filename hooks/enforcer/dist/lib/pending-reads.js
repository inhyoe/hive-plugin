 ...
 */
export function readPendingReads(stateDir) {
 ...
 */
export function writePendingReads(stateDir, paths) {
 ...
 */
export function hasPendingReads(stateDir) {
 ...
 */
export function clearReadPath(stateDir, readPath, repoRoot) {
    acquireLock(stateDir);
    try {
        ...
        const remaining = pending.filter((p) => normalizePath(p, repoRoot) !== normalizedRead);
...
//# sourceMappingURL=pending-reads.js.map